...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTCOMMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPORTCOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTCOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTCOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTCOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTCOMMENTS actions', async () => {
      const expectedActions = [
        {
