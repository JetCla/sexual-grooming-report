...
export const ReportDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sexualGroomingReportsApp.report.delete.question">
        <Translate contentKey="sexualGroomingReportsApp.report.delete.question" interpolate={{ id: reportEntity.id }}>
