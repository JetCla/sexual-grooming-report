...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTLOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPORTLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTLOG actions', async () => {
      const expectedActions = [
        {
