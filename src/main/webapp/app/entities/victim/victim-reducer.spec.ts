...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './victim.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VICTIM_LIST actions', async () => {
    ...
    it('dispatches FETCH_VICTIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VICTIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VICTIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VICTIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VICTIM actions', async () => {
      const expectedActions = [
        {
